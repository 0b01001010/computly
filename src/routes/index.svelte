...
<CommonSEO title="Home | Computly" />

<main class="main-content border border-primary {darkMode ? 'bg-dark' : 'bg-light'}">
	<div class="text">
		<h1>We make modern websites</h1>
		<p>
			I'm a full stack web developer who creates futuristic looking websites for companies across
			the world.
		</p>
		<div
			class="call2action"
			style="--main-btn-bg-clr:{darkMode ? 'rgb(97, 99, 211)' : 'rgb(228, 221, 255)'}"
		>
			<a sveltekit:prefetch href="/contact" class="contact">Get in touch</a>
			<a href="https://portfolio.computly.me" class="portfolio" rel="external" target="_blank">
				Portfolio
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
					<path fill="none" d="M0 0h24v24H0z" />
					<path
						d="M10 6v2H5v11h11v-5h2v6a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h6zm11-3v8h-2V6l-8 8-1-1 8-8h-5V3h8z"
					/>
				</svg>
			</a>
		</div>
...
<style lang="scss">
	...
	$main-btn-border-radius: 0.25rem;
	$main-btn-transition: all 200ms linear;
	$main-btn-padding: 0.5em 1em;
	main {
		display: grid;
		...
		.text {
			...
			.call2action {
				...
				a.contact {
					...
					position: relative;
					box-shadow: $home-btn-shadow;
					transition: $main-btn-transition;
					overflow: hidden;
				...
				a.portfolio {
					...
					&::after {
						...
						height: 10%;
						width: 100%;
						background: linear-gradient(90deg, #416d72 0%, #be928d 100%);
